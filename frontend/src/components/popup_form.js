...
export default function PopUp({ onClose, onSave, isOpen, sessions = [], tags = [] }) {
  ...
  return (
    <div className="w-full h-full grid place-items-center fixed inset-0 z-50">
      <div className="grid grid-rows-[auto_1fr] bg-white text-gray-900 shadow-xl max-w-full md:max-w-2xl lg:max-w-2xl w-full max-h-full md:max-h-full lg:max-h-9/10 py-5 px-10 sm:rounded-xl overflow-y-auto md:overflow-hidden">
