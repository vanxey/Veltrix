...
export default function MD_card_analytics({title, chart_description, win_title, win_data, loss_title, loss_data, className=""}){
    ...
    return (
        <div className={`flex flex-col gap-10 shadow-md border border-gray-100 w-auto bg-white rounded-xl p-10 ${className}`}>

            <div className="flex text-2xl font-bold">{title}</div>

            <div className="flex flex-col place-items-center">
                <div className="relative">
                    <div className="flex" style={{height: "200px", width: "200px"}}>
